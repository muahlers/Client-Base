...
export default class Spawner {
  constructor(scene, level, playerSpeed, stage) {
    ...
    this.stages = [
      ...
      },
      {
        ...
        blocks: [
          ...
          ['vieja_76_people_61_skater_36_telefono_5_moneda', 'gente'],
          ['vieja_76_people_46_moncho_36_perro_5_moneda', 'gente'],
          ['vieja_76_people_71_skater_36_telefono_5_moneda', 'gente'],
    ...
    this.obstaculosStats = [
      ...
      {
        type: 'gente',
        platformSpawnRange: [5000, 7000].map((x) => x - (this.level * 90)),
        xPosition: window.game.config.width,
      },
      {
        type: 'autos',
